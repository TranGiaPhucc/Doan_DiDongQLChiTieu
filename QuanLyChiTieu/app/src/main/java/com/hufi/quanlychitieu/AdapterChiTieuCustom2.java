...
public class AdapterChiTieuCustom2 extends ArrayAdapter<NguoiDung> {
    Context context;
    int layoutResource;
    ArrayList<NguoiDung> data;
    Database db;

    public AdapterChiTieuCustom2(@NonNull Context context, int resource, @NonNull ArrayList<NguoiDung> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        String myUsername = ChiTieuCustom.myUsernameAdapter;
